...
def convert_to_openapispec():
    ...
    parser.add_argument(
        "-b", "--basedir", required=True, help="basedir of family"
    )
    parser.add_argument(
        "-l", "--lones", required=True, help="comma separated resource names"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--infile", required=False, help="full path of schema file"
    )
    parser.add_argument(
