...
def main(args):
    ...
    openapiglobal["servers"] = [{"url": "/" + family, "description": family}]
    ...
    if args.infile:
        ...
        create_openapi_spec(
            openapi, args.infile, openapidir, family, args.outfmt, args.module
        )
        return
...
def create_openapi_spec(
    openapi, schemafile, openapidir, family, outfmt, inputmodule=None
):
    """
